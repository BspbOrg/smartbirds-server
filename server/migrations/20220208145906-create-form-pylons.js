...
const schema = {
  ...
  pylonTypeLocal: Sequelize.TEXT,
  pylonTypeLang: Sequelize.STRING(3),
  speciesNestOnPylon: Sequelize.TEXT,
  typeNestEn: Sequelize.TEXT,
  typeNestLocal: Sequelize.TEXT,
  typeNestLang: Sequelize.STRING(3),
  pylonInsulated: Sequelize.BOOLEAN,
