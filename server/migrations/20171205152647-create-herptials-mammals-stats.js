...
module.exports = {
  up: function (queryInterface, Sequelize) {
    ...
    return Promise.all([
      ...
      queryInterface.sequelize.query('CREATE OR REPLACE VIEW herptials_stats (' +
  ...
  down: function (queryInterface, Sequelize) {
    ...
    return Promise.all([
      ...
      queryInterface.sequelize.query('DROP VIEW IF EXISTS herptials_stats'),
