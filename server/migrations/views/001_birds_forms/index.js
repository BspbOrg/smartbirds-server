...
const views = [
  ...
  require('./002_birds_top_species_month'),
  require('./002_birds_top_users_records_month'),
  require('./002_birds_top_users_records_year'),
  require('./002_birds_top_users_species_month'),
  require('./002_birds_top_users_species_year')
]
