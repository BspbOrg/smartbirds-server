  ...
  routes: function (api) {
    return {
      ...
      get: [
        ...
        { path: '/suspicious-activity-alert/:id', action: 'suspiciousActivityAlert:view' },
      ...
      post: [
        ...
        { path: '/suspicious-activity-alert/:id', action: 'suspiciousActivityAlert:update' },
        ...
        { path: '/tasks/detect-suspicious-activity', action: 'tasks:enqueue:detectSuspiciousActivity' },
