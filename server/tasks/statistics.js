  ...
  run: async function (api, params, next) {
    try {
      const stats = await Promise.props({
        ...
        birds_migrations_top_interesting_species_month_stats: api.models.birds_migrations_top_interesting_species_month.findAll({
          include: [
            api.models.birds_migrations_top_interesting_species_month.associations.migrationPoint,
            api.models.birds_migrations_top_interesting_species_month.associations.speciesInfo,
            api.models.birds_migrations_top_interesting_species_month.associations.user
          ],
          limit: 20
        }).then(records => records.map(r => r.apiData(api))),
        birds_migrations_peak_daily_species_stats: api.models.birds_migrations_peak_daily_species.findAll({
          include: [
            api.models.birds_migrations_peak_daily_species.associations.migrationPoint,
            api.models.birds_migrations_peak_daily_species.associations.speciesInfo
          ]
        }).then(records => records.map(r => r.apiData(api))),
        birds_migrations_season_totals_stats: api.models.birds_migrations_season_totals.findAll({
          include: [
