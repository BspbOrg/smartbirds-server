  ...
  async initialize () {
    api.serverConfig = {
      ...
      supportedConfigVariables: [
        ...
        'SUSPICIOUS_ACTIVITY_BULK_REQUEST_COUNT',
        'SUSPICIOUS_ACTIVITY_BULK_TIME_WINDOW_MINUTES',
        'SUSPICIOUS_ACTIVITY_RAPID_REQUEST_COUNT',
        'SUSPICIOUS_ACTIVITY_RAPID_TIME_WINDOW_MINUTES',
        'SUSPICIOUS_ACTIVITY_RAPID_LOOKBACK_MINUTES',
        'SUSPICIOUS_ACTIVITY_IP_SWITCHING_DISTINCT_IPS',
        'SUSPICIOUS_ACTIVITY_IP_SWITCHING_TIME_WINDOW_MINUTES',
        'SUSPICIOUS_ACTIVITY_SESSION_TIME_WINDOW_MINUTES'
      ],
      get: async () => {
        try {
